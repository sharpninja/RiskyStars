...
public static class ThemedUIFactory
{
    ...
    public static Panel CreateGameplayPanel(Color? borderColor = null)
    {
        return new Panel
        {
            Background = ThemeManager.CreateSolidBrush(Color.Black * 0.72f),
            Border = ThemeManager.CreateSolidBrush(borderColor ?? ThemeManager.Colors.BorderNormal),
    ...
    public static Panel CreateViewportFrame(int width, int? height = null)
    {
        ...
        {
            Width = width,
            Background = ThemeManager.CreateSolidBrush(Color.Black * 0.78f),
    ...
    public static Panel CreateListRowPanel(bool selected = false)
    {
        return new Panel
        {
            Background = ThemeManager.CreateSolidBrush(selected
                ? ThemeManager.Colors.BorderFocus * 0.22f
                : Color.Black * 0.58f),
...
#pragma warning restore CS0618
    ...
    public static Panel CreateResourceIcon(Color color)
    {
        var outer = new Panel
        {
            ...
            Background = ThemeManager.CreateSolidBrush(Color.Black * 0.7f),
            Border = ThemeManager.CreateSolidBrush(ThemeManager.Colors.BorderNormal),
            BorderThickness = new Thickness(ThemeManager.BorderThickness.Thin),
