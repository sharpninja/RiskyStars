...
public static class ThemeManager
{
    ...
    public static float CurrentUiScaleFactor => Math.Clamp(_themeProfile.UiScalePercent / 100f, 0.8f, 1.6f);

    public static int ScalePixels(int value, int minimum = 1)
    {
        return Math.Max(minimum, (int)MathF.Round(value * CurrentUiScaleFactor));
    }
    ...
    {
        style.Background = CreatePanelFillBrush();
        style.OverBackground = CreateRaisedPanelFillBrush();
        style.FocusedBackground = CreateRaisedPanelFillBrush();
    ...
    private static void ConfigureComboBoxStyle(ComboBoxStyle style)
    {
        style.Background = CreatePanelFillBrush();
        style.OverBackground = CreateRaisedPanelFillBrush();
        style.PressedBackground = CreateRaisedPanelFillBrush();
        style.FocusedBackground = CreateRaisedPanelFillBrush();
        style.Border = CreateSolidBrush(Colors.BorderNormal);
        style.OverBorder = CreateSolidBrush(Colors.BorderFocus);
        style.FocusedBorder = CreateSolidBrush(Colors.BorderFocus);
    ...
    private static void ConfigureTabControlStyle(TabControlStyle style)
    {
        ...
        style.ContentStyle.Background = CreatePanelFillBrush();
        style.ContentStyle.Border = CreateSolidBrush(Colors.BorderNormal);
        ...
        style.TabItemStyle.Background = CreateRaisedPanelFillBrush();
        style.TabItemStyle.OverBackground = CreateAccentPanelFillBrush(Colors.BorderFocus, 48);
        style.TabItemStyle.PressedBackground = CreateAccentPanelFillBrush(Colors.BorderFocus, 72);
        style.TabItemStyle.Border = CreateSolidBrush(Colors.BorderNormal);
    ...
    {
        style.Background = CreatePanelFillBrush(226);
        style.Border = CreateSolidBrush(Colors.BorderNormal);
        style.OverBorder = CreateSolidBrush(Colors.BorderFocus);
        style.FocusedBorder = CreateSolidBrush(Colors.BorderFocus);
        style.BorderThickness = new Thickness(BorderThickness.Thin);
    ...
    {
        window.Background = CreatePanelFillBrush(226);
        window.Border = CreateSolidBrush(highlighted ? Colors.BorderFocus : Colors.BorderNormal);
        window.BorderThickness = new Thickness(highlighted ? BorderThickness.Normal : BorderThickness.Thin);
        window.Padding = Padding.Medium;
        window.TitleTextColor = Colors.TextWarning;
        window.TitleFont = UiFonts.Heading;
    }

    public static void ApplyGameplayWindowTheme(Window window, bool highlighted = false)
    {
        window.Background = CreatePanelFillBrush(226);
        window.Border = CreateSolidBrush(highlighted ? Colors.BorderFocus : Colors.BorderNormal);
        window.BorderThickness = new Thickness(highlighted ? BorderThickness.Normal : BorderThickness.Thin);
        window.Padding = Padding.Medium;
        window.TitleTextColor = Colors.TextPrimary;
        window.TitleFont = UiFonts.Heading;
    }
    ...
    public static void ApplyPanelTheme(Panel panel, PanelTheme theme = PanelTheme.Default)
    {
        switch (theme)
        {
            case PanelTheme.Frame:
                panel.Background = CreatePanelFillBrush();
            ...
            case PanelTheme.AccentFrame:
                panel.Background = CreateAccentPanelFillBrush(Colors.BorderFocus, 44);
            ...
            case PanelTheme.Hero:
                panel.Background = CreateAccentPanelFillBrush(Colors.HeroColor, 34);
            ...
            case PanelTheme.Dark:
                panel.Background = CreatePanelFillBrush(236);
                panel.Border = CreateSolidBrush(Colors.BorderNormal);
                panel.BorderThickness = new Thickness(BorderThickness.Thin);
                panel.Padding = Padding.Large;
                break;
    ...
    {
        textBox.Background = CreatePanelFillBrush();
        textBox.OverBackground = CreateRaisedPanelFillBrush();
        textBox.FocusedBackground = CreateRaisedPanelFillBrush();
    ...
    {
        comboBox.Background = CreatePanelFillBrush();
        comboBox.OverBackground = CreateRaisedPanelFillBrush();
        comboBox.FocusedBackground = CreateRaisedPanelFillBrush();
        ...
        comboBox.ListBox.Background = CreatePanelFillBrush();
    ...
    {
        spinButton.Background = CreatePanelFillBrush();
    ...
    private static SolidBrush CreatePanelFillBrush(byte alpha = 214)
    {
        return CreateSolidBrush(new Color((byte)8, (byte)10, (byte)12, alpha));
    }

    private static SolidBrush CreateRaisedPanelFillBrush(byte alpha = 226)
    {
        return CreateSolidBrush(new Color((byte)18, (byte)22, (byte)24, alpha));
    }

    private static SolidBrush CreateAccentPanelFillBrush(Color accent, byte alpha)
    {
        return CreateSolidBrush(new Color(accent.R, accent.G, accent.B, alpha));
    }
    ...
    public static class Sizes
    {
        ...
        public static int IconSmall => ScalePixels(16);
        public static int IconMedium => ScalePixels(18);
        public static int IconLarge => ScalePixels(24);

        public static int PanelSmallWidth => ScalePixels(300);
        public static int PanelMediumWidth => ScalePixels(420);
        public static int PanelLargeWidth => ScalePixels(560);
        public static int PanelXLargeWidth => ScalePixels(820);
    ...
    private sealed class ThemeProfile
    {
        ...
        public static ThemeProfile FromSettings(UiThemeSettings? rawSettings, int uiScalePercent)
        {
            ...
            float paddingScale = uiScale;
            float frameScale = uiScale;
            ...
            return new ThemeProfile
            {
                ...
                TinyFontSize = 12f * fontScale,
                SmallFontSize = 15f * fontScale,
                BodyFontSize = 18f * fontScale,
                ButtonFontSize = 20f * fontScale,
                HeadingFontSize = 24f * fontScale,
                TitleFontSize = 34f * fontScale,
                HeroFontSize = 46f * fontScale,
