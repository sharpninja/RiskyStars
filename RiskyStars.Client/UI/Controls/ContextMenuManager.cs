...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    private void SendSplitArmyCommand(string armyId, int splitCount)
    {
        ...
        GameFeedbackBus.PublishBusy("Submitting split-army order", $"Requesting a split of {splitCount} unit(s).");
        ...
        Task.Run(async () =>
        {
            ...
            catch (Exception ex)
            {
                ...
                GameFeedbackBus.PublishError("Split army failed", ex.Message);
            }
        });
    }
    ...
    private void SendMergeArmiesCommand(string sourceArmyId, string targetArmyId)
    {
        ...
        GameFeedbackBus.PublishBusy("Submitting merge order", "Requesting an army merge.");
        ...
        Task.Run(async () =>
        {
            ...
            catch (Exception ex)
            {
                ...
                GameFeedbackBus.PublishError("Merge armies failed", ex.Message);
            }
        });
    }
    ...
    private void SendMergeAllArmiesCommand(List<ArmyState> armies)
    {
        ...
        GameFeedbackBus.PublishBusy("Submitting merge-all order", $"Requesting a merge of {armyIds.Count} armies.");
        ...
        Task.Run(async () =>
        {
            ...
            catch (Exception ex)
            {
                ...
                GameFeedbackBus.PublishError("Merge all armies failed", ex.Message);
            }
        });
    }
    ...
    private void SendAssignHeroCommand(string armyId, string heroName)
    {
        ...
        GameFeedbackBus.PublishBusy("Submitting hero assignment", $"Assigning hero {heroName}.");
        ...
        Task.Run(async () =>
        {
            ...
            catch (Exception ex)
            {
                ...
                GameFeedbackBus.PublishError("Assign hero failed", ex.Message);
            }
        });
    }
    ...
    private void SendUpgradeStellarBodyCommand(string bodyId, string upgradeName)
    {
        ...
        GameFeedbackBus.PublishBusy("Submitting upgrade order", $"Requesting upgrade {upgradeName}.");
        ...
        Task.Run(async () =>
        {
            ...
            catch (Exception ex)
            {
                ...
                GameFeedbackBus.PublishError("Upgrade request failed", ex.Message);
            }
        });
    }
    ...
    private void SendReinforceLocationCommand(string locationId, LocationType locationType, int unitCount)
    {
        ...
        GameFeedbackBus.PublishBusy("Submitting reinforcement order", $"Reinforcing with {unitCount} unit(s).");
    ...
    private void SendFormAllianceCommand(string targetPlayerId)
    {
        ...
        GameFeedbackBus.PublishBusy("Submitting alliance proposal", "Requesting a diplomatic alliance.");
        ...
        Task.Run(async () =>
        {
            ...
            catch (Exception ex)
            {
                ...
                GameFeedbackBus.PublishError("Alliance proposal failed", ex.Message);
            }
        });
    }
    ...
    private void SendBreakAllianceCommand(string targetPlayerId)
    {
        ...
        GameFeedbackBus.PublishBusy("Breaking alliance", "Sending a diplomatic break action.");
        ...
        Task.Run(async () =>
        {
            ...
            catch (Exception ex)
            {
                ...
                GameFeedbackBus.PublishError("Break alliance failed", ex.Message);
            }
        });
    }
