...
public class SettingsWindow
{
    ...
    private readonly Action<int>? _onPreviewUiScaleChanged;
...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    private int _openedUiScalePercent;
    private bool _uiScalePreviewDirty;
    
    public bool IsOpen => _window?.Visible ?? false;
    
    public SettingsWindow(GraphicsDeviceManager graphics, Settings settings, Action<Settings>? onApply = null, Action<int>? onPreviewUiScaleChanged = null)
    {
        _graphics = graphics;
        _settings = settings;
        _onApply = onApply;
        _onPreviewUiScaleChanged = onPreviewUiScaleChanged;
        _tempSettings = settings.Clone();
        _openedUiScalePercent = settings.UiScalePercent;
    ...
    private void CreateUI()
    {
        ...
        {
            Title = "Settings",
            Width = ThemeManager.ScalePixels(700),
            Height = ThemeManager.ScalePixels(550),
            Visible = false
        };
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        _uiScaleSlider = new HorizontalSlider
        {
            ...
            Width = ThemeManager.ScalePixels(250),
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        _uiScaleSlider.ValueChanged += (s, e) =>
        {
            ...
            {
                int scale = (int)Math.Round(_uiScaleSlider.Value);
                _uiScaleValueLabel.Text = $"{scale}%";

                if (_onPreviewUiScaleChanged != null)
                {
                    _uiScalePreviewDirty = scale != _openedUiScalePercent;
                    _onPreviewUiScaleChanged(scale);
                }
            }
        };
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        contentStack.Widgets.Add(new Panel { Height = ThemeManager.ScalePixels(20) });
    ...
    private void CreateAudioTab()
    {
        ...
        contentStack.Widgets.Add(new Panel { Height = ThemeManager.ScalePixels(10) });
...
#pragma warning disable CS0618 // Type or member is obsolete
        slider = new HorizontalSlider
        {
            ...
            Maximum = 100,
            Value = value * 100,
            Width = ThemeManager.ScalePixels(300),
            VerticalAlignment = VerticalAlignment.Center
        };
#pragma warning restore CS0618 // Type or member is obsolete
...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    private void CreateControlsTab()
    {
        ...
        shortcutsStack.Widgets.Add(CreateShortcutLabel("F4", "Toggle UI Scale Panel"));
        ...
        shortcutsStack.Widgets.Add(CreateShortcutLabel("Right Mouse Drag", "Pan by Dragging"));
...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    private void OnApplyClicked(object? sender, EventArgs e)
    {
        ApplyChanges();
        _settings.Save();
        _openedUiScalePercent = _settings.UiScalePercent;
        _uiScalePreviewDirty = false;
    ...
    {
        if (_uiScalePreviewDirty && _onPreviewUiScaleChanged != null)
        {
            _onPreviewUiScaleChanged(_openedUiScalePercent);
            _settings.UiScalePercent = _openedUiScalePercent;
        }
    ...
    private void CenterWindow()
    {
        if (_window != null && _graphics != null)
        {
            ...
            var windowWidth = _window.Width ?? ThemeManager.ScalePixels(700);
            var windowHeight = _window.Height ?? ThemeManager.ScalePixels(550);
