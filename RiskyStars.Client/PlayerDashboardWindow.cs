...
public class PlayerDashboardWindow : DockableWindow
{
    ...
    private Widget BuildResourcePanel()
    {
        ...
        _populationStockpileLabel.Width = 140;
        ...
        _metalStockpileLabel.Width = 140;
    ...
    private Widget BuildHeroPanel()
    {
        ...
        _assignToArmyButton = ThemedUIFactory.CreateButton("Assign to Army", 170, ThemeManager.Sizes.ButtonSmallHeight, ThemeManager.ButtonTheme.Hero);
        _assignToArmyButton.Enabled = false;
        _assignToArmyButton.Click += (s, a) => AssignHeroToArmy();
        layout.Widgets.Add(_assignToArmyButton);
        
        _assignToRegionButton = ThemedUIFactory.CreateButton("Assign to Region", 170, ThemeManager.Sizes.ButtonSmallHeight, ThemeManager.ButtonTheme.Hero);
        ...
        _recallHeroButton = ThemedUIFactory.CreateButton("Recall Hero", 170, ThemeManager.Sizes.ButtonSmallHeight, ThemeManager.ButtonTheme.Danger);
